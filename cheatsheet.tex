...
\node [mybox] (box){%
    ...
    \begin{itemize}[noitemsep, topsep=0pt]
        ...
        \item[(iii)] $E_1,E_2,\cdots \in \mathcal{A}\Rightarrow \bigcup^{\infty}_{i=1}E_i\in\mathcal{A}$ ($\bigcap E^C_i \in\mathcal{A}$, $\bigcup E^C_i\in\mathcal{A}$, $\bigcap E_i\in\mathcal{A}$ as well).
    \end{itemize}
    
    Some examples:
    \begin{itemize}[noitemsep, topsep=0pt]
        \item[-] Trivial $\sigma-$field:$\mathcal{A}=\{\varnothing,\Omega\}$
        \item[-] Largest $\sigma-$field: powerset of $\Omega$, $\mathcal{P}(\Omega)$
    \end{itemize}
    \end{minipage}
};
%------------ sigma field (Lec1) ---------------------
